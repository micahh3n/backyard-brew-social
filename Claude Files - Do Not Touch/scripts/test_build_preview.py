...
def test_build_preview_includes_event_and_captions():
    rows = [_row(event="Bingo Night", fb_caption="FB text here", ig_caption="IG text here",
                scheduled_time="2026-07-13 11:00", generated_image="2 Posters and Flyers/Social Graphics/x.png")]
    ...
    assert "2 Posters and Flyers/Social Graphics/x.png" in html_out
...
def test_build_preview_renders_additional_photos_beyond_the_first():
    row = _row(event="Tacos + Poker Club", fb_caption="x", ig_caption="y",
              ...
              generated_image="2 Posters and Flyers/Social Graphics/main.png",
              photos="2026-07-15_poker.jpg, weds_taco.jpg")
    html_out = build_preview.build_preview([row])
    assert "../../2 Posters and Flyers/Social Graphics/main.png" in html_out
    assert "../../3 Photos/weds_taco.jpg" in html_out
