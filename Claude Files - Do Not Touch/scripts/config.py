...
# ---------------------------------------------------------------------------
# Paths. The top folder holds only what a person opens (numbered folders);
# everything Claude uses lives in SYSTEM_DIR, which is the parent of /scripts.
# ---------------------------------------------------------------------------
SYSTEM_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
REPO_ROOT = os.path.dirname(SYSTEM_DIR)
PHOTOS_DIR = os.path.join(REPO_ROOT, "3 Photos")
LOGO_DIR = os.path.join(REPO_ROOT, "4 Logo")
RECURRING_CSV = os.path.join(SYSTEM_DIR, "recurring_events.csv")
POSTS_CSV = os.path.join(SYSTEM_DIR, "posts.csv")
STATUS_LOG = os.path.join(SYSTEM_DIR, "status.log")
...
GENERATED_DIR = os.path.join(REPO_ROOT, "2 Posters and Flyers", "Social Graphics")
