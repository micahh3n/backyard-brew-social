...
"$PY" -m pip install --quiet -r "$SYSTEM/requirements.txt"
...
"$PY" "$SYSTEM/playbook/make-pdfs.py" --selfcheck >/dev/null && echo "  PDF builder ok"
...
Start by opening "0 START HERE.pdf" at the top of the folder.
The other guides are in "5 How-To Guides".
DONE
