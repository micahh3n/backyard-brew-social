...
| Day | Event | Angle |
|---|---|---|
| Monday | Bingo Night — 10 rounds themed bingo, 6:30pm, free w/ beer purchase, themed + beer + food + cash prizes, kids welcome w/ soda, name-that-tune at halftime | Prize-reveal — what are we playing for this week? |
