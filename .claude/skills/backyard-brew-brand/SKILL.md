...
| Day | Event | Angle |
|---|---|---|
| Monday | Bingo Night — 10 rounds themed bingo, 6:30pm, free w/ beer purchase, themed + beer + food prizes, kids welcome w/ soda, name-that-tune at halftime. **LRC is a separate game played after bingo ends (details unverified, ask)** — see the money-language rule in `references/caption-voice-rules.md` before writing about it | Prize-reveal — what are we playing for this week? |
