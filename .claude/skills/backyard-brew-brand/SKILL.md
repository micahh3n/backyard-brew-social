...
| Tuesday | Pickleball Open Play — free w/ beer purchase, **5:30pm (changed 2026-09-09, was 6:30pm)**, random doubles tournament, hot dogs served all night, winner gets free beer, enter by 5:40pm or auto-placed in losers bracket | Challenge/competitive — think you can beat the regulars? |
| Wednesday | Tacos + Poker Club — beef tacos, quesadillas; poker starts 6pm, free to play w/ beer purchase. **Loaded nachos removed from the menu 2026-09-09 — never mention nachos for this event going forward** | Food first, then the game — tacos are the hook |
| Thursday | Board Games & Movie Night (new 2026-09-09, replaces the old Thursday market slot) — board games start 6:30pm, a different random movie plays each week while you play, free, casual hang not a tournament. **Launch date not yet set as of 2026-09-10 — doesn't run the week of 9/8, too late to promote properly. Tease/build anticipation only, never say it's happening on a specific night until a date is confirmed** | Chill/casual hangout — no pressure, just games and a surprise movie |
| Friday | Karaoke Night — 8pm start, all skill levels, variety of genres | "Weekend starts NOW" energy |
| Saturday | Donk Toss (new 2026-09-09, replaces Pool Night) — register 6-6:30pm, practice 6:30-7pm, game 7-9pm. **Full rules/format not finalized — tease only, don't explain how it's played, "more details coming soon."** Also: **launch date not yet set as of 2026-09-10 — doesn't run the week of 9/8 either, Saturday reverts to no special event that week** | Curiosity/tease — what is Donk Toss? |
| Sunday | Backyard Market & Brews (moved from Thursday 2026-09-13; no market at all Aug 28-Sep 12, the Aug 27 Moonlight Market is genuinely the last Thursday one) — weekly vendor market + live local music, noon-4pm, setup **10am-noon (changed 2026-09-09, was 9am-11:45am)**, rain or shine, a rotating lineup of local vendors (count varies, never state a fixed number) + a different musician every week. **Top weekly promotional priority — promote heavily every single week.** 2026-09-13 band is Bret Paulch | Extremely community/local-business-focused — a small-business showcase, not a party. Full rules in `references/backyard-market-brews.md`, read it before writing this event's captions |
